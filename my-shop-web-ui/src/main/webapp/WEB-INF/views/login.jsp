...
<div class="dengl_beij">
    <div class="banner_xin">
        <img src="/static/assets/images/ss.jpg">
    </div>
    <div class="beij_center dengl_jvz">
        <div class="login_form">
            ...
            <div class="kengl_kuang">
                ...
                <div class="txt_kuang">
                    <input id="email" name="email" type="text" class="itxt"  placeholder="邮箱/用户名/已验证手机">
                    <input id="password" name="password" type="password" class="itxt"  placeholder="密码">
                    <input id="verification" name="verification" type="text" class="itxt" style="width: 120px" placeholder="验证码">
                    <img id="validation_image" src="/verification" style="cursor: pointer;float: right;padding-right: 23px" title="看不清？换一张">
                </div>
                <div class="remember">
                    <div class="fl">
            ...
            <div class="corp_login">
                ...
                <div class="regist_link"><a href="signUp" target="_blank"><b></b>立即注册</a></div>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(function () {
        // 刷新验证码
        $("#validation_image").bind("click", function () {
